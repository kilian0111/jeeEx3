...
```js
import Vue from 'vue';
import KeenUI from 'src/main/webapp/keen-ui/dist/keen-ui';
import 'n/webapp/keen-ui/dist/keen-ui.css';
...
```js
import Vue from 'vue';
import '/src/bootstrap'; // Required when using standalone components, should be imported only once in your project
